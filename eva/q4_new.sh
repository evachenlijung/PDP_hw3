...
q2_csv = os.path.expanduser("~/hw3/eva/logs/q2_new/q2_new_strong_scaling.csv")
logs_dir   = os.path.expanduser("~/hw3/eva/logs/q4_new")
...
plt.tight_layout()
outpath = os.path.join(logs_dir, "q4_new_speedup_efficiency.png")
