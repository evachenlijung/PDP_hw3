...
q2_csv = os.path.expanduser("~/hw3/eva/logs/q2_v3/q2_v3_strong_scaling.csv")
logs_dir   = os.path.expanduser("~/hw3/eva/logs/q4_v3")
...
plt.tight_layout()
outpath = os.path.join(logs_dir, "q4_v3_speedup_efficiency.png")
